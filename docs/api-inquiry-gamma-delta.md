...
plan.phase_changed                  { planId, fromPhase, toPhase }
plan.status_changed                 { planId, fromStatus, toStatus }
plan.subtask_status_changed         { planId, subtaskId, status }
branch.created                      { branchId, conversationId, mode, parentBranchId? }
branch.archived                     { branchId }
branch.adopted                      { branchId, summaryMessageId }
