...
| [roundtableConsensusPersistencePlan_2026-05-07](./roundtableConsensusPersistencePlan_2026-05-07.md) | **P1 ready (devbug GitHub #263)** — RT 환각/오동작 3 영역 복합 회복: (a) consensus 영구화 부재 → 라운드 간 합의 망각 / 같은 합의 재시도 / 3 fail 사용자 fallback 영구 반복 / 사용자 RT 사용 포기. (b) RT marker 부재 → main conv 단일 에이전트 dispatch 시 합의 무시 / 라운드 재실행 환각. (c) Architect ContextPack 의 RT consensus 섹션 부재 → "마지막 라운드만 정리". 6 task → 4 PR 분리 (사용자 시나리오 회신 / consensus schema v50 / marker 격리 + Architect 인계 / test + docs). 시나리오 SSOT: `docs/reference/roundtableReproductionScenarios_2026-05-07.md` |
