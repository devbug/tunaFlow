...
| [watchdogAndReviewerReadGuardPlan_2026-04-29](./watchdogAndReviewerReadGuardPlan_2026-04-29.md) | **P1 (MERGED PR #212 / 8aa944c)** — claude.rs watchdog trailing kill 차단 (RAII guard) + REVIEWER_TEMPLATE 에 `*-result.md` read 금지 명시. 2 task 합본 |
| [rawqVendorFallbackPlan_2026-04-29](./rawqVendorFallbackPlan_2026-04-29.md) | **P0 (MERGED PR #216 / f9c36ea)** — `build-rawq.{sh,ps1}` 자동 git clone fallback + INSTALL/README. 외부 contributor 진입 장벽 차단 |
| [onboardingAnalysisFailureAndSkipUiPlan_2026-04-29](./onboardingAnalysisFailureAndSkipUiPlan_2026-04-29.md) | **P1 (MERGED PR #215 / 016c8e7)** — Error 상태 "건너뛰기" 버튼 회복 (Task 01). Task 02 진단 → 별 plan `onboardingCodexStderrSurfacePlan_2026-04-29` 로 분기 (F1 PR #222 머지) |
| [globalSettingsAndRecentProjectsPlan_2026-04-29](./globalSettingsAndRecentProjectsPlan_2026-04-29.md) | **P1 (MERGED PR #217+#218 / 50b24ea+6d01c7c)** — Cmd+, 글로벌 단축키 + macOS 메뉴 (Task 01) + recent projects DB v48 + UI (Task 02). +5 v48 unit test |
| [nativeNotificationPlan_2026-04-29](./nativeNotificationPlan_2026-04-29.md) | **P2 (MERGED PR #220 / 7f23670)** — Path B `objc2` 직접 bridge → `UNUserNotificationCenter`. 권한 UX 옵션 D. 진단 audit: `tauri::is_dev()` + `set_application("com.apple.Terminal")` 강제 분기 root cause 확정 |
| [docsPanelScopePolicyPlan_2026-04-29](./docsPanelScopePolicyPlan_2026-04-29.md) | **P2 (MERGED PR #219 / d7cffa9)** — 좌측 문서 패널 P3-Lite scope=`'all'\|'tunaflow'`, default=`'all'`. 3 task |
| [onboardingCodexStderrSurfacePlan_2026-04-29](./onboardingCodexStderrSurfacePlan_2026-04-29.md) | **F1 (MERGED PR #222 / 5459a0f)** — codex stderr piped 만으로 다음 사용자 보고 시 H1~H4 가설 즉시 확정 (observability 회복). F2~F5 는 향후 사용자 보고 후 별 PR |
| [claudeRateLimitVisibilityPlan_2026-04-29](./claudeRateLimitVisibilityPlan_2026-04-29.md) | **superseded by `claudeTransportFlipHardeningPlan_2026-04-29`** — 진단 history 보존 (5h 한도 / Opus 별 한도 / billing path 가설 모두 빗나감) |
| [claudeTransportFlipHardeningPlan_2026-04-29](./claudeTransportFlipHardeningPlan_2026-04-29.md) | **P0 ready (v0.1.5-beta release blocker)** — v0.1.4-beta transport flip 후속: stale resume_token 자동 detect + fresh session fallback + ContextPack revival + rate_limit 가시화. 8 task. Phase 1 (T1~T4) = 사용자 액션 0 자동 회복 핵심. Developer 핸드오프 포함 |
| [entrolyAdoptionPlan_2026-05-02](./entrolyAdoptionPlan_2026-05-02.md) | **P1 ready (v0.1.4 publish 후 첫 cycle)** — Entroly (Apache-2.0, 0.10.0) token compression engine 도입. **3 Phase 통합 계획서**: Phase 1 (E2 proxy sidecar, P0 fast track) → Phase 2 (E1 direct integration + E4 distillation, v0.1.6-beta) → Phase 3 (E3 PRISM RL + E5 semantic dedup, v0.2.0+). T11/T12 binary drop 의 architectural 격상 + 70~95% token savings. uncertainty 검증 영역 §6 명시 |
| [scaffoldUserCustomizationPreservationPlan_2026-05-03](./scaffoldUserCustomizationPreservationPlan_2026-05-03.md) | **P1 (devbug GitHub #254)** — scaffold 가 docs/agents/*.md 의 사용자 customize 영역 덮어쓰기 회귀. **2 영역 fix**: (A) ARCHITECT_TEMPLATE 의 result task 자동 inject 차단, (B) sentinel 마커 (`<!-- BEGIN user-customize -->`) 기반 보존 정책 + migration. PR #211/#212 후속 |
| [branchChatInputRegressionPlan_2026-05-03](./branchChatInputRegressionPlan_2026-05-03.md) | **P1 (devbug GitHub #255)** — plan revision 후 기존 plan 의 branch chat input 사라짐 (대화 내역만 남음). 진단 우선 (Task 01) → hotfix (Task 02). frontend UI 분기 회귀 가능성 가장 높음 |
| [reviewerVerdictDirectArchitectPlan_2026-05-04](./reviewerVerdictDirectArchitectPlan_2026-05-04.md) | **MERGED v0.1.6-beta** — Reviewer verdict (pass/fail/conditional) 라우팅을 Meta-agent inbox 우회 → Architect 직행으로 전환 + askMeta UX 폐지. PR #260/#261/#262 + Gemini follow-up + docs SSOT. c-2 scope (Meta role 부분 축소, 전면 해체 아님) |
| [windowsCaptionBarMissingPlan_2026-05-07](./windowsCaptionBarMissingPlan_2026-05-07.md) | **P0 ready (devbug GitHub #264)** — Windows 빌드의 캡션바 / 닫기·최소화·최대화 native control 부재 hotfix. tauri.conf.json 의 `titleBarStyle: "Overlay"` + `hiddenTitle: true` 가 macOS 전용인데 cross-platform 적용되어 Windows native titleBar 차단. platform-conditional override 분리. 3 task 1 PR. v0.1.6-beta-2 patch 또는 v0.1.7-beta minor |
| [roundtableConsensusPersistencePlan_2026-05-07](./roundtableConsensusPersistencePlan_2026-05-07.md) | **MERGED v0.1.7-beta** (PR #265/#266/#267) — RT 환각/오동작 3 영역 복합 회복 완료. consensus schema v50 + RT marker v51 + Architect ContextPack 인계. Rust 614→635 (+21), INV-RTC-1~8 보존. devbug #263 자동 close + 회복 안내 댓글 |
| [claudeSdkSessionWindowGuardPlan_2026-05-09](./claudeSdkSessionWindowGuardPlan_2026-05-09.md) | **P0 ready (사용자 본인 환경 회귀)** — Reviewer "Prompt is too long" 회귀. root cause = `MAX_TOTAL_PROMPT` (60K) 가 outgoing system 영역만 가드, claude SDK 세션 누적 history 미가드. accumulated_input_tokens 임계 (180K default / 900K `[1m]`) → 자동 fresh-rotate + toast. Reviewer specific squeeze (plan_doc 6K→3K, LIMIT 20→10) 보조. 6 task → 4 PR 분리. v0.1.8-beta minor. Plan A (#264 Windows) 는 Windows 10 호환 한계로 별 cycle 보류 |
