...
- [scaffoldUserCustomizationPreservationDeveloperHandoff_2026-05-03](./scaffoldUserCustomizationPreservationDeveloperHandoff_2026-05-03.md) — **#254 fix 핸드오프 (P1)**. Plan: `scaffoldUserCustomizationPreservationPlan_2026-05-03`. 영역 A (ARCHITECT_TEMPLATE result task 자동 inject 차단) + 영역 B (docs/agents/*.md sentinel 마커 기반 사용자 customize 보존 + migration 백업). 두 영역 분리 PR 권장.
- [branchChatInputRegressionDeveloperHandoff_2026-05-03](./branchChatInputRegressionDeveloperHandoff_2026-05-03.md) — **#255 fix 핸드오프 (P1)**. Plan: `branchChatInputRegressionPlan_2026-05-03`. plan A 진행 중 plan B 머지 → plan A revision 후 dev branch 의 chat input 사라짐 회귀. Task 01 진단 (1시간 timeout) → Task 02 frontend hotfix.
